...
get_feature_paths() {
    ...
    # Plan artifacts live under plans/{feature-name}/ where feature-name matches
    # the spec directory basename (e.g. specs/001-room-management → plans/001-room-management).
    local feature_name plan_dir
    feature_name="$(basename "$feature_dir")"
    plan_dir="$repo_root/plans/$feature_name"
